...
struct proc
{
  ...
  // Project 1B
  // Adding new system calls STEP 3
  // Add required info for system calls inside proc struct
  // adding the following fields to proc, used for getschedhistory.
  ...
  // Project 1C
  // Added required fields for the mlfq as per the guidelines of Project 1C
  // MLFQ scheduling specific fields
